...
namespace IdentityServer4.Dapper.Mappers
{
    public class ClientMapperProfile : Profile
    {
        ...
        {
            CreateMap<Entities.ClientProperty, KeyValuePair<string, string>>().ReverseMap();

            CreateMap<Entities.Client, IdentityServer4.Models.Client>().ForMember(dest => dest.ProtocolType, opt => opt.Condition(
                    srs => srs != null)).ReverseMap();
