...
namespace IdentityServer4.Dapper.Stores.SqlServer
{
    ...
    {
        private readonly ILogger<SqlServerResourceStore> logger;
        private readonly DapperStoreOptions configurationStoreOptions;
        ...
        public async Task<ApiResource> FindApiResourceAsync(string name)
        {
            ...
            using (var connection = new SqlConnection(configurationStoreOptions.DbConnectStrings))
            {
        ...
        public async Task<IEnumerable<ApiResource>> FindApiResourcesByScopeAsync(IEnumerable<string> scopeNames)
        {
            ...
            using (var connection = new SqlConnection(configurationStoreOptions.DbConnectStrings))
            {
                ...
                if (apir != null && apir.Count > 0)
                {
                    ...
                    logger.LogDebug("Found {scopes} API scopes in database", apiResourceData.SelectMany(x => x.Scopes).Select(x => x.Name));
                }
            }
